...
#if 0
#define SynaPrint(dbglevel, dbgcatagory, fmt, ...) {          \
    if (SynaDebugLevel >= dbglevel &&                         \
        (SynaDebugCatagories && dbgcatagory))                 \
		    {                                                           \
        DbgPrint(DRIVERNAME);                                   \
