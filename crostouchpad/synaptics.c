...
NTSTATUS
SynaProcessIdleRequest(
	IN PSYNA_CONTEXT pDevice,
...
)
{
	...
	*Complete = TRUE;
...

	{
		...
		WDF_WORKITEM_CONFIG_INIT(&workitemConfig, SynaIdleIrpWorkItem);
...
)
{
	...
	case IOCTL_HID_SEND_IDLE_NOTIFICATION_REQUEST:
		...
		status = SynaProcessIdleRequest(devContext, Request, &completeRequest);
		break;
